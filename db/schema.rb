...
ActiveRecord::Schema.define(version: 2019_10_02_152935) do
  ...
  create_table "backers", force: :cascade do |t|
    ...
    t.index ["project_id"], name: "index_backers_on_project_id", unique: true
    t.index ["user_id"], name: "index_backers_on_user_id", unique: true
  end
